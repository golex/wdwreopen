...
function IconPicker({ name, className }) {
    ...
    switch (name) {
        ...
        case "MK":
            return (
                <img alt="mickey mouse by SoyGalem from the Noun Project" className={className} src={mkIllustration} />
            );
        case "AK":
            return <img alt="scar by SoyGalem from the Noun Project" className={className} src={akIllustration} />;
        case "EP":
            return (
                <img
        ...
        case "calendar":
            return <RiCalendarCheckLine className={className} />;
        case "firework":
            return <GiFireworkRocket className={className} />;
        case "mickey":
            return <RiMickeyLine className={className} />;
        case "cauldron":
            return <GiCauldron className={className} />;
        case "mask":
            return <MaskIcon className={className} />;
        case "bag":
            return <FaShoppingBag className={className} />;
        case "shop":
            return <GiShop className={className} />;
        case "door":
            return <GiExitDoor className={className} />;
        case "clock":
            return <BsClockHistory className={className} />;
        case "food":
            return <RiRestaurantLine className={className} />;
        case "village":
            return <GiVillage className={className} />;
        case "ride":
            return <RideIcon className={className} />;
        case "map":
            return <RiMapPinLine className={className} />;
        case "link":
            return <RiExternalLinkLine className={className} />;
        case "hotel":
            return <GiBed className={className} />;
        case "up":
            return <RiArrowUpSLine className={className} />;
        case "down":
        ...
        case "top":
            return <RiArrowUpLine className={className} />;
    }
    return null;
}
